...
RegisterNUICallback('depositarpop', function(data, cb)
	TriggerServerEvent('esx_atm:depositarpop', data.amount)
	cb('ok')
end)

RegisterNUICallback('sacarpop', function(data, cb)
	TriggerServerEvent('esx_atm:sacarpop', data.amount)
	cb('ok')
end)
