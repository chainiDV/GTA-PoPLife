...
RegisterNUICallback('register', function(data, cb)
	...
	--	TriggerEvent('esx_skin:openSaveableMenu', myIdentifiers.id)
		...
		--chaini_characterCreator system
		TriggerEvent('chaini_CharacterCreator:openMenu')
	else

		TriggerEvent('chat:addMessage', { args = { '^1[IDENTITY]',reason } })
	end
end)
...
Citizen.CreateThread(function()
	while true do
		if guiEnabled then
			...
			DisableControlAction(0, 79, true) -- C
