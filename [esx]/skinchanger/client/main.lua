...
local FaceComponents = {
	{label = "Tamaño nariz",				name = 'Nose_Width',				value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Punta nariz",					name = 'Nose_Peak_Hight',			value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Semejanza",					name = 'Nose_Peak_Lenght',			value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Color piel",					name = 'Nose_Bone_High',			value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Semejanza",					name = 'Nose_Peak_Lowering',		value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Color piel",					name = 'Nose_Bone_Twist',			value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Semejanza",					name = 'EyeBrown_High',				value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Color piel",					name = 'EyeBrown_Forward',			value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Tamaño nariz",				name = 'Cheeks_Bone_High',			value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Punta nariz",					name = 'Cheeks_Bone_Width',			value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Semejanza",					name = 'Cheeks_Width',				value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Color piel",					name = 'Eyes_Openning',				value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Semejanza",					name = 'Lips_Thickness',			value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Color piel",					name = 'Jaw_Bone_Width',			value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Semejanza",					name = 'Jaw_Bone_Back_Lenght',		value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Color piel",					name = 'Chimp_Bone_Lowering',		value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Semejanza",					name = 'Chimp_Bone_Lenght',			value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Color piel",					name = 'Chimp_Bone_Width',			value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Semejanza",					name = 'Chimp_Hole',				value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Color piel",					name = 'Neck_Thikness',				value = 0.0,			min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
...
local Components = {
	...
	{label = _U('face'),					name = 'faceP',				value = 1,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = _U('face'),					name = 'faceM',				value = 1,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Semejanza",					name = 'semejanza',			value = 1.0,	min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	{label = "Color piel",					name = 'ColorPiel',			value = 1.0,	min = 0,	zoomOffset = 0.6,		camOffset = 0.65},
	...
	{label = _U('tshirt_1'),				name = 'tshirt_1',			value = 111,	min = 0,	zoomOffset = 0.75,		camOffset = 0.15},
	{label = _U('tshirt_2'),				name = 'tshirt_2',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	textureof	= 'tshirt_1'},
	{label = _U('torso_1'),					name = 'torso_1',			value = 7,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15},
	...
	{label = _U('arms'),					name = 'arms',				value = 6,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15},
	{label = _U('arms_2'),					name = 'arms_2',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15},
	{label = _U('pants_1'),					name = 'pants_1',			value = 49,		min = 0,	zoomOffset = 0.8,		camOffset = -0.5},
	{label = _U('pants_2'),					name = 'pants_2',			value = 0,		min = 0,	zoomOffset = 0.8,		camOffset = -0.5,	textureof	= 'pants_1'},
	{label = _U('shoes_1'),					name = 'shoes_1',			value = 9,		min = 0,	zoomOffset = 0.8,		camOffset = -0.8},
...
for i=1, #FaceComponents, 1 do
	Character[FaceComponents[i].name] = FaceComponents[i].value
end
...
function ApplySkin(skin, clothes)
	...
	for i=1, #FaceComponents, 1 do
		SetPedFaceFeature(GetPlayerPed(-1),	Config.featureEnum[FaceComponents[i].name], Character[FaceComponents[i].name])
	end

	SetPedHeadBlendData			(playerPed, Character['faceM'], Character['faceP'], 0, Character['faceM'], Character['faceP'], 0,Character['semejanza'], Character['ColorPiel'], 0.0, false)
...
AddEventHandler('skinchanger:loadSkin', function(skin, cb)
	...
	TriggerEvent('skinchanger:skinLoaded')
	LastSex = skin['sex']
end)
