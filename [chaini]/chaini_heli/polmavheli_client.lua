...
function IsPlayerInPolmav()
	...
	local chash = GetHashKey("supervolito")
	local ahash = GetHashKey("swift")
	local bhash = GetHashKey("as350")
	if IsVehicleModel(vehicle, ahash) or IsVehicleModel(vehicle, bhash) or IsVehicleModel(vehicle, chash) or IsVehicleModel(vehicle, dhash) then
		return true
	else
		return false
	end
