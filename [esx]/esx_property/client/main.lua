  ...
  ESX.UI.Menu.Open(
    ...
    function(data2, menu)
      ...
      if data2.current.value == 'buy' then
        TriggerServerEvent('esx_property:comprarPropiedadPop', property.name)
      end
    ...
    function(data, menu)
      ...
      ESX.UI.Menu.Open(
        ...
        function(data2, menu)
          ...
          if data2.current.value == 'buy' then
            TriggerServerEvent('esx_property:comprarPropiedadPop', data.current.value)
          end
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.type == 'item_weapon' then
          ...
          TriggerServerEvent('esx_property:getitemPop', owner, data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              if quantity == nil then
                ...
                TriggerServerEvent('esx_property:getitemPop', owner, data.current.type, data.current.value, quantity)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.type == 'item_weapon' then
          ...
          TriggerServerEvent('esx_property:ponerItemPop', owner, data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              TriggerServerEvent('esx_property:ponerItemPop', owner, data.current.type, data.current.value, tonumber(data2.value))
