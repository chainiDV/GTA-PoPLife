...
AddEventHandler('esx_truck_inventory:getInventory', function(id)
  local inventory_ = {}
...
RegisterServerEvent('esx_truck_inventory:closeMenu')
AddEventHandler('esx_truck_inventory:closeMenu', function(client)
  TriggerClientEvent('esx_truck_inventory:closedMenu',client)
end)
