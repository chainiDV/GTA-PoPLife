...
Config.Cloakroom = {
	CloakRoom = {
			Pos   = {x = 176.92, y = 6399.76, z = 30.32},
...
------------------------------------------- Blaine County
	...
	RetourCamion = {
			Pos   = {x = 193.2408, y = 6381.36, z = 30.4},
			Color = {r = 204, g = 204, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Type  = 1,
	...
	AnnulerMission = {
			Pos   = {x = 206.12, y = 6383.7067, z = 30.4},
			Color = {r = 204, g = 204, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Type  = 1,
