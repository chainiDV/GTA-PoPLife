...
RegisterServerEvent('esx_mecanojob:NPCMisionCompletadaPop')
AddEventHandler('esx_mecanojob:NPCMisionCompletadaPop', function()
  ...
  TriggerEvent('esx_addonaccount:getCompartidaCuentaPop', 'society_mecano', function(account)
...
AddEventHandler('esx_mecanojob:getStockItem', function(itemName, count)
  ...
  TriggerEvent('esx_addoninventory:getCompartidoInventarioPop', 'society_mecano', function(inventory)

    local item = inventory.getItem(itemName)

    if item.count >= count and item.count > 0 then
...
--  TriggerEvent('esx_addoninventory:getCompartidoInventarioPop', 'society_policestock', function(inventory)
--    cb(inventory.items)
--  end)
...
RegisterServerEvent('esx_mecano:paythem')
AddEventHandler('esx_mecano:paythem',function(precio)
  TriggerEvent('es:getPlayerFromId',source, function(user)
      user.addMoney(precio)
      TriggerClientEvent('chatMessage', source, 'Empresario | ', {255, 0, 0}, "Has ganado "..precio.."€.")
  end)
end)