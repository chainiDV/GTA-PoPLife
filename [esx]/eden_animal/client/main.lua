...
function buy_animal()
    ...
    local price = price
    local elements = {}
    table.insert(elements, {label = _U('dog') .. '- <span style="color:green;">$200000</span>',             					value = "chien",	price = 200000})		
    table.insert(elements, {label = _U('cat') .. '- <span style="color:green;">$120000</span>',             					value = "chat", price = 120000})
    table.insert(elements, {label = _U('wolf') .. '- <span style="color:green;">$200000</span>',             					value = "loup", price = 200000})
    table.insert(elements, {label = _U('bunny') .. '- <span style="color:green;">$50000</span>',             					value = "lapin",	price = 50000})
    table.insert(elements, {label = _U('husky') .. '- <span style="color:green;">$150000</span>',             					value = "husky", price = 150000})
    table.insert(elements, {label = _U('pig') .. '- <span style="color:green;">$160000</span>',             					value = "cochon", price = 160000})
    table.insert(elements, {label = _U('poodle') .. '- <span style="color:green;">$110000</span>',             					value = "caniche", price = 110000})
    table.insert(elements, {label = _U('pug') .. '- <span style="color:green;">$200000</span>',             					value = "carlin", price = 200000})
    table.insert(elements, {label = _U('retriever') .. '- <span style="color:green;">$135000</span>',             					value = "retriever", price = 135000})
    table.insert(elements, {label = _U('asatian') .. '- <span style="color:green;">$165000</span>',             					value = "berger", price = 165000})
    table.insert(elements, {label = _U('westie') .. '- <span style="color:green;">$110000</span>',             					value = "westie", price = 110000})
    ...
    function(data, menu)
            ...
            TriggerServerEvent('eden_animal:cogeranimalpop', data.current.value, data.current.price)
            menu.close()
