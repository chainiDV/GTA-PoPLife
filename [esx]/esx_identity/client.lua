...
RegisterNUICallback('register', function(data, cb)
  if data.firstname == "" or data.firstname == "" or data.lastname == "" or data.dateofbirth == ""  or data.sex == "" or data.height == "" then
    TriggerServerEvent('esx_identity:advert',"No puedes dejar campos en blanco")
    EnableGui(false)
    Wait (500)
    EnableGui(true)
  else
    ...
    EnableGui(false)
    Wait (500)
    TriggerEvent('chaini_CharacterCreator:firstAnimation')
