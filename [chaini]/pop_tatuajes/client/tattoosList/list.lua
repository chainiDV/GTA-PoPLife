...
tattoosCategories = {
	{name = "Parte 1", value = "mpbeach_overlays"},
	{name = "Parte 2", value = "mpbusiness_overlays"},
	{name = "Parte 3", value = "mphipster_overlays"}
}



tattoosShops = {
	{x=1864.08,y=3748.04,z=32.04},
	{x=-276.24,y=6226.0,z=31.60},
}