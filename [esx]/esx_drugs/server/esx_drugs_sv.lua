	...
	SetTimeout(5000, function()
		...
		if PlayersHarvestingCoke[source] == true then
			...
			if coke.limit ~= -1 and coke.count >= coke.limit then
				...
				xPlayer.anadirInventarioItemPoP('coke', 1)
				HarvestCoke(source)
			end
	...
	SetTimeout(10000, function()
		...
		if PlayersTransformingCoke[source] == true then
			...
			elseif cokeQuantity < 5 then
				...
				xPlayer.retirarInventarioItemPoP('coke', 5)
				xPlayer.anadirInventarioItemPoP('coke_pooch', 1)
	...
	SetTimeout(7500, function()
		...
		if PlayersSellingCoke[source] == true then
			...
			if poochQuantity == 0 then
				...
				xPlayer.retirarInventarioItemPoP('coke_pooch', 1)
	...
	SetTimeout(5000, function()
		...
		if PlayersHarvestingMeth[source] == true then
			...
			if meth.limit ~= -1 and meth.count >= meth.limit then
				...
				xPlayer.anadirInventarioItemPoP('meth', 1)
				HarvestMeth(source)
			end
	...
	SetTimeout(12000, function()
		...
		if PlayersTransformingMeth[source] == true then
			...
			elseif methQuantity < 5 then
				...
				xPlayer.retirarInventarioItemPoP('meth', 5)
				xPlayer.anadirInventarioItemPoP('meth_pooch', 1)
	...
	SetTimeout(7500, function()
		...
		if PlayersSellingMeth[source] == true then
			...
			if poochQuantity == 0 then
				...
				xPlayer.retirarInventarioItemPoP('meth_pooch', 1)
				if CopsConnected == 0 then
	...
	SetTimeout(5000, function()
		...
		if PlayersHarvestingWeed[source] == true then
			...
			if weed.limit ~= -1 and weed.count >= weed.limit then
				...
				xPlayer.anadirInventarioItemPoP('weed', 1)
				HarvestWeed(source)
			end
	...
	SetTimeout(7500, function()
		...
		if PlayersTransformingWeed[source] == true then
			...
			elseif weedQuantity < 5 then
				...
				xPlayer.retirarInventarioItemPoP('weed', 5)
				xPlayer.anadirInventarioItemPoP('weed_pooch', 1)
	...
	SetTimeout(7500, function()
		...
		if PlayersSellingWeed[source] == true then
			...
			if poochQuantity == 0 then
				...
				xPlayer.retirarInventarioItemPoP('weed_pooch', 1)
                if CopsConnected == 0 then
	...
	SetTimeout(5000, function()
		...
		if PlayersHarvestingOpium[source] == true then
			...
			if opium.limit ~= -1 and opium.count >= opium.limit then
				...
				xPlayer.anadirInventarioItemPoP('opium', 1)
				HarvestOpium(source)
			end
	...
	SetTimeout(10000, function()
		...
		if PlayersTransformingOpium[source] == true then
			...
			elseif opiumQuantity < 5 then
				...
				xPlayer.retirarInventarioItemPoP('opium', 5)
				xPlayer.anadirInventarioItemPoP('opium_pooch', 1)
	...
	SetTimeout(7500, function()
		...
		if PlayersSellingOpium[source] == true then
			...
			if poochQuantity == 0 then
				...
				xPlayer.retirarInventarioItemPoP('opium_pooch', 1)
				if CopsConnected == 0 then
...
ESX.RegisterUsableItem('weed', function(source)
	...
	xPlayer.retirarInventarioItemPoP('weed', 1)
